...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Train an XGBoost baseline on the run-cell model table."
    )
    parser.add_argument(
        "--input",
    ...
    parser.add_argument(
        "--output",
        default="artifacts/run_cell_xgboost_metrics.json",
...
def main() -> None:
    ...
    print(f"Wrote XGBoost metrics to {output_path}")
